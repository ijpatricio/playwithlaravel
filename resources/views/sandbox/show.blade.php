    ...
    <div class="flex h-screen w-screen">
        ...
        <div class="w-1/2 border rounded-lg">
            <div class="flex">
                ...
                <input type="text" id="address" class="flex-grow border rounded-r p-1" value="/playground/{{ $sandbox->ulid }}" />
            </div>
            <iframe src="/php-wasm/cgi-bin/{{ $sandbox->ulid }}" class="w-full h-full border"></iframe>
        </div>
    </div>
@endsection
